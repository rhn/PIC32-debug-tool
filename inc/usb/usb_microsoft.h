...
// TODO CHECK, this should generally be done per-struct with struct  __attribute__((__packed__)) my_struct {, see https://stackoverflow.com/questions/8568432/is-gccs-attribute-packed-pragma-pack-unsafe
#pragma pack(push, 1)
...
// TODO SAME CHECK HERE AS ABOVE, for packing/unpackign structs.
#pragma pack(pop)
